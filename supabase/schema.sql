...
alter table public.stripe_events add column if not exists stripe_fee integer;
alter table public.stripe_events add column if not exists stripe_net integer;
...
alter table public.stripe_refunds add column if not exists stripe_fee integer;
alter table public.stripe_refunds add column if not exists stripe_net integer;
